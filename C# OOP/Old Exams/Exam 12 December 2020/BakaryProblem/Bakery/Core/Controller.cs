...
using Bakery.Models.BakedFoods.Entitis;
using Bakery.Models.Drinks.Entitis;
using Bakery.Models.Tables.Entitis;
...
namespace Bakery.Core
{
    public class Controller : IController
    {
        ...
        public string GetFreeTablesInfo()
        {
            ...
            foreach (var freebable in freeTables)
            {
                result += freebable.GetFreeTableInfo() + "\r\n";
            }
